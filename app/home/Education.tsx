  ...
  return (
    <div className="mt-3 mb-10">
      ...
      <div className="flex flex-col grid-cols-9 p-2 mx-auto md:grid">
        ...
        <div
            className="relative p-4 my-6 bg-blue-500 text-white dark:bg-lime-400 dark:text-black rounded-xl col-start-1 col-end-5 mr-auto md:mr-0 md:ml-auto flex items-center shadow-md flex-col md:flex-row"
          >
            <Image
              src={Bachelor}
              alt="Education 1"
              className="w-20 h-15 mb-4 md:mb-0 md:mr-4"
            />
            <div>
        ...
        <div className="flex md:contents">
          ...
          <div
            className="relative p-4 my-6 bg-blue-500 text-white dark:bg-lime-400 dark:text-black rounded-xl col-start-6 col-end-10 mr-auto flex items-center shadow-md flex-col md:flex-row"
          >
            <Image
              src={APS}
              alt="Education 1"
